...
Rastreamento de todos os lançamentos que alteraram a conta corrente.
...
|----------------------------------------------------------------------------|--------------------------------------------------------------------|
| [WS-Lista LOG Alterações em Conta-Corrente](Web-Services/WS-Lista-LOG-Alteracoes-em-Conta-Corrente.md) | Lista os lançamentos efetuados na sessão |
...
_Diagrama UML: [UML-Classes-Log-Rastreamento-Contas.asta](FU-Log-Rastreamento-Contas-Anexos/UML-Classes-Log-Rastreamento-Contas.asta)_
