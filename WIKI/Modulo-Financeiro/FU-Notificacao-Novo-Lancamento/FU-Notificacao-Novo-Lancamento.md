...
[Home](../../ReadMe.md) :: [Módulo Financeiro](../Modulo-Financeiro.md) :: [Notificação Novo Lançamento](FU-Notificacao-Novo-Lancamento)


# Funcionalidade: Notificação Novo Lançamento

## Descrição

Exibe uma notificação HTML a cada inclusão de novo lançamento.
...
_Diagrama UML: [UML-Classes-Notificacao-Novo-Lancamento.asta](FU-Notificacao-Novo-Lancamento-Anexos/UML-Classes-Notificacao-Novo-Lancamento.asta)_
